...
const translations = {
  ko: {
    'brand.name': 'QuERA Quantum Festival 2026',
    ...
    'hero.kpi.sessions': '⏱️ 세미나 & 튜토리얼',
    'hero.kpi.handsOn': '🧪 Qiskit 핸즈온',
    'hero.kpi.challenge': '🏆 QCNN 챌린지',
    'hero.kpi.networking': '👥 네트워킹',
    'about.title': '행사 소개',
    'about.description':
      '<strong>제2회 QuERA Quantum Festival</strong>은 부산대학교 양자컴퓨팅 동아리 <strong>QuERA</strong>가 주최하는 1박 2일 양자컴퓨팅 행사입니다. 이번 행사는 <strong>QCNN(Quantum Convolutional Neural Network)</strong>을 메인 주제로, 양자 컴퓨팅을 처음 접하는 초보자도 강연·실습·해커톤·네트워킹을 통해 양자 회로 설계와 AI 응용을 직접 경험할 수 있도록 구성되어 있습니다.',
    ...
    'schedule.title': '일정(안)',
    'schedule.part1.title': '5/22 (금) · 강의 + 실습 + 챌린지 킥오프',
    ...
    'schedule.part2.title': '5/23 (토) · 챌린지 마감 + 발표 + 시상',
    ...
    'venue.title': '장소',
    'venue.address':
      '<strong>부산대학교 IT관 정보컴퓨터공학부 강의실</strong><br />부산광역시 금정구 부산대학로63번길 2 (장전동)',
    'venue.note': '세부 호실/입장 동선은 행사 전 참가자 안내 메일로 공지됩니다. (강의실 미정)',
    'faq.title': 'FAQ',
    ...
    'footer.copy': '© 2026 QuERA · 부산대학교 양자컴퓨팅동아리',
  ...
  en: {
    ...
    'hero.kpi.sessions': '⏱️ Seminars & Tutorials',
    'hero.kpi.handsOn': '🧪 Qiskit Hands-on',
    'hero.kpi.challenge': '🏆 QCNN Challenge',
    'hero.kpi.networking': '👥 Networking',
    'about.title': 'About the Event',
    'about.description':
      '<strong>The 2nd QuERA Quantum Festival</strong> is a two-day quantum computing event hosted by <strong>QuERA</strong>, the quantum computing club at Pusan National University. This edition focuses on <strong>QCNN (Quantum Convolutional Neural Network)</strong>, offering newcomers a chance to experience quantum circuit design and AI applications through talks, hands-on labs, hackathon, and networking.',
    ...
    'schedule.part1.title': 'May 22 (Fri) · Lectures + Labs + Challenge Kickoff',
    ...
    'schedule.part2.title': 'May 23 (Sat) · Challenge Submission + Presentations + Awards',
    ...
    'venue.title': 'Venue',
    'venue.address':
      '<strong>Pusan National University, IT Building (Dept. of Computer Science & Engineering)</strong><br />2, Busandaehak-ro 63beon-gil, Geumjeong-gu, Busan',
    'venue.note': 'Room details (TBD) and entry guidance will be emailed to participants before the event.',
    'faq.title': 'FAQ',
    ...
    'footer.copy': '© 2026 QuERA · Quantum Computing Club at Pusan National University',
    'footer.email': 'Email: hjkim2124@pusan.ac.kr',
    'footer.github': 'GitHub',
