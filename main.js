...
const translations = {
  ko: {
    ...
    'nav.toggle': '주요 메뉴 열기',
    'hero.date': '2026.05.29 (금) 10:00 - 18:00 · 부산대학교 IT관(102) 306호',
    ...
    'venue.title': '장소',
    'venue.address':
      '<strong>부산대학교 IT관(102) 306호</strong><br />부산광역시 금정구 부산대학로63번길 2 (장전동)',
  ...
  en: {
    ...
    'hero.date': 'May 29 (Fri) 10:00 - 18:00, 2026 · PNU IT Building (No. 102), Room 306',
    ...
    'venue.title': 'Venue',
    'venue.address':
      '<strong>Pusan National University, IT Building (No. 102), Room 306</strong><br />2, Busandaehak-ro 63beon-gil, Geumjeong-gu, Busan',
